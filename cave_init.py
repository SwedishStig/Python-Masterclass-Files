...
with shelve.open("cave", writeback=True) as cave_make:
    cave_make["locations"] = {0: {"desc": "You are sitting in front of a computer learning Python",
                                  "exits": {},
                                  "namedExits": {}},
